    ...
    <div className="data-card">
      <div className='flex'>
        <select className='language-select-box' onChange={(e) => setLanguage(e.target.value)}>
          <option defaultValue value='en'>{t('languages.en')}</option>
          <option value='hnd'>{t('languages.hnd')}</option>
          <option value='sns'>{t('languages.sns')}</option>
          <option value='pu'>{t('languages.pu')}</option>
          ...
          <option value='ka'>{t('languages.ka')}</option>
          <option value='ma'>{t('languages.ma')}</option>
          <option value='mar'>{t('languages.mar')}</option>
          <option value='od'>{t('languages.od')}</option>
        </select>
